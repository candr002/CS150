...
//If (x1,y1) and (x2,y2) are the coordinates of two
//points in the XY-plane, then the distance between these points is
//sqrt((x2-x1)^2 + (y2-y1)^2).
// HEY! This is very similar to the calculation required in project one!

//demo of the string object length function
